...
parser.add_argument('--nDataLoaderThread', type=int, default=24,     help='Number of loader threads')
parser.add_argument('--augment',        type=bool,  default=False,  help='Augment input')
parser.add_argument('--seed',           type=int,   default=3407,     help='Seed for the random number generator')
...
parser.add_argument('--weight_decay',   type=float, default=0.1,      help='Weight decay in the optimizer')
